...
data_dict = {
    ...
    '生产总值': [8681.37, 9340.16, 10313.07, 11202.98, 11803.32, 12370.48],
    '总人口': [480.9007, 486.2, 493.05, 497.21, 502.83, 508.97],
    '货运量': [15353, 15830, 17385, 18640, 20601, 21691],
    '社会消费品零售总额': [2186.34, 2357.62, 2585.69, 2785.21, 3024.34, 2994.36],
    '农村居民人均可支配收入': [24155, 26158, 28358, 30787, 33574, 35750],
    '城缜居民人均可支配收入': [45129, 48628, 52659, 56989, 61915, 64714],
    '全社会用电量': [598.18, 600.5, 638.67, 686.67, 732.81, 750.82]
}
import pandas as pd
