...
# Setting up for displaying Chinese characters and negative signs properly
mpl.rcParams["font.sans-serif"] = ["SimHei"]  # Use SimHei font for displaying Chinese characters
mpl.rcParams["axes.unicode_minus"] = False  # Ensure negative signs are displayed correctly
